...
public class FeatureParserTest {
    ...
    @Test
    @DisplayName("Given all fields in a GUARANTEE feature should parse object")
    void givenGuaranteeFeatureShouldParse() {

        Guarantee guaranteeFeature = new Guarantee();
        guaranteeFeature.setName("guarantee");
        guaranteeFeature.setDescription(null);
        ...
        assertEquals(guaranteeFeature, pricingManager.getFeatures().get("guarantee"));
